...
function Header({sendDataToParent}) {
  ...
  return (
    <>
      <Box w="95vw" display="flex" justifyContent="space-between" alignItems="center" pt="4px" color="white">
        <Box onClick={() => changeValues("", "80, 100")} className="RAWG-logo" alignSelf="left" mr="8" fontSize="lg" fontWeight="800" letterSpacing="wide">R A W G</Box>
        ...
        <Stack color="white"  ml="2em" direction="row" letterSpacing="wide" spacing={4} alignItems="center">
          <Link color="white" fontSize="sm" href="https://rawg.io/login">LOG IN</Link>
          <Link color="white" fontSize="sm" href="https://rawg.io/signup">SIGN UP</Link>
          <Link color="white" fontSize="sm" href="https://rawg.io/apidocs">API</Link>
          <Link color="white" fontSize="sm" href="https://rawg.io/apidocs">...</Link>
        </Stack>
      </Box>
    </>
  )
